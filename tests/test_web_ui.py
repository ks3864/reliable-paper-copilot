...
class WebUITests(unittest.TestCase):
    ...
    def test_web_ui_references_existing_api_routes(self):
        ...
        self.assertIn('document.getElementById("retrieval-mode").addEventListener("change"', response.text)
        ...
        self.assertIn('document.getElementById("retrieval-mode").value = initialUiState.retrievalMode || "dense";', response.text)
